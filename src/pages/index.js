    ...
    <Layout location={location} title={siteTitle}>
      ...
      <main className="main">
        ...
        <section className="section--about">
          ...
          <p className="sub--texts">Me Considero una Persona Independiente, Apasionada por Aprender Nuevas Arias tecnologicas q me Ayuden a Alcanzar mis Objetivos como Persona Emprendera 🚀.</p>
        ...
        <section className="section--project">      
          <section className="section--about">
            ...
            <h3 className="sub--texts">listado de Proyectos personales</h3>
        ...
        <section className="content--stack">
          ...
          <section className="section--about">
            ...
            <p  className="sub--texts">Desarrollador JavaScript Full Stack Develop, cuento con las habilidades para desempeñarme en trabajos de full stack, 
            con una amplia experiencia en el uso de tecnologias de desarrollo web.</p>
